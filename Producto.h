#ifndef POOIFINALPROJECT_PRODUCTO_H
#define POOIFINALPROJECT_PRODUCTO_H
...
public:
    Producto() {}
    ~Producto() {}
    Producto(int codigo, string nombre, string categoria,string marca,int cantidad, float precio)
    {
...
#endif //POOIFINALPROJECT_PRODUCTO_H
